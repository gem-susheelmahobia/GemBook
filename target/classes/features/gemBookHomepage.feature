Feature: GemBook Homepage Features
  ...
  Background: These steps are common for every scenario
    ...
    And User enters gmail "susheel.mahobia@geminisolutions.com" and password "Gunjan@143" and click on next button
...
#      | Achievements | Findings | Announcements |
  ...
  # Issue raised for filters button.
###########################################
#
...
#      | Achievements | Generic       |
   ...
   #doubt to discuss regarding page refresh thing and dropdown left open
    ################################
...
#      | Name  |
 ...
 # Profile image click issue again screen getting blank
    ###################################
...
#
#  Scenario: Check that View more comments link should be displayed if post has more then one comment
#    When User checks the post having more then one comment

#  Scenario: Check that clicking on View More Comments link is showing all comments with view less comment option
#    When Click on View More comment link


#  Scenario: Check that clicking on View Less Comments link after view More Comment link is showing one comment
